...
const submitForm = async () => {
  ...
  try {
    ...
    errorMsg.value = err.data?.statusMessage || 'Failed to create delivery option'
  } finally {
    loading.value = false
  }
}
  ...
  <div>
    <div class="sm:flex sm:items-center sm:justify-between mb-8">
      <div class="flex items-center">
        ...
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Create Delivery Option</h1>
      </div>
    </div>
