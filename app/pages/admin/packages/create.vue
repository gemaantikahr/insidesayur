...
const submitForm = async () => {
  ...
  try {
    ...
    errorMsg.value = err.data?.statusMessage || 'Failed to create package'
  } finally {
    loading.value = false
  }
}
  ...
  <div>
    <div class="sm:flex sm:items-center sm:justify-between mb-8">
      <div class="flex items-center">
        ...
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Create Package</h1>
      </div>
    </div>
        ...
        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="sm:col-span-2">
            ...
            <div class="mt-2 relative">
              ...
              <input type="number" step="0.01" min="0" id="price" v-model="form.price" required class="block w-full rounded-md border-0 py-1.5 pl-7 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6" />
            </div>
          </div>
